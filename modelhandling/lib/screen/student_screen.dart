...
class _StudentPageState extends State<StudentPage> {
  ...
  void addStudent() async {
    ...
    double? quiz = double.tryParse(quizController.text);
    double? activity = double.tryParse(activityController.text);
    double? exam = double.tryParse(examController.text);

    if (quiz == null || activity == null || exam == null) {
      showMessage('Please enter valid numbers for quiz, activity, and exam');
      return;
    }
  ...
  void deleteStudent(String id, String name) async {
    showDialog(
      context: context,
          ...
          children: [
            ...
            Align(
              ...
              child: IconButton(
                onPressed: () {
                  if (student.id == null) {
                    showMessage('Cannot delete: missing student id');
                    return;
                  }
